...
export function CanvasToolbar({
  ...
  return (
    ...
    >
      ...
      <DropdownMenu>
        <DropdownMenuTrigger aria-label="排列节点" title="排列节点" disabled={nodeCount < 2} className={cn(buttonVariants({ variant: "ghost", size: "icon-sm" }))}>
      ...
      <DropdownMenu>
        <DropdownMenuTrigger aria-label="画布显示设置" title="画布显示设置" className={cn(buttonVariants({ variant: "ghost", size: "icon-sm" }))}>
